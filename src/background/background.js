(function (chrome, $) {
    ...
    chrome.extension.onRequest.addListener(function (request, sender, sendResponse) {
        ...
        var defaultDate = function () {
            var now = new Date();
            var nextday = new Date(now.getFullYear(), now.getMonth(), now.getDate() + 1, 0, now.getTimezoneOffset() * (-1), 0, 0);
            var formattedDate = String(10000 * nextday.getFullYear() + 100 * (nextday.getMonth() + 1) + nextday.getDate());
        ...
        var appConfig = [
                ...
                name: "quota", url: "/eticketing/mainpage.jsf" },
            {
                ...
                class: {
                    ...
                    options: [
                        { value: "1A", label: "1A" }, { value: "2A", label: "2A" }, { value: "3A", label: "3A" },
