    ...
    chrome.extension.onRequest.addListener(
        function (request, sender, sendResponse) {
            ...
            var appConfig = [
                ...
                {
                    key: "name", displayName: "Profile Name", placeholder: "Profile Name",
                    control: "input", type: "text", url: "fake", required: true
                },
                {
                ...
                {
                    key: "from", displayName: "From Station", placeholder: "From Station",
                    control: "typeahead", type: "text", required: true,
                ...
                },
                {
                    ...
                    trainNum: {
                        key: "trainNum", displayName: "Train Number", placeholder: "Train Number",
                ...
                },
                {
                    ...
                    psgSenior: {
                        key: "psgSenior", displayName: "Senior Citizen", control: "input", type: "checkbox",
                ...
                //    id:"jpform:ticketType",name:"jpform:ticketType",
                // options:[{ value: "E_TICKET", label: "E-ticket" }],url:"/eticketing/home12"}
            ];
